...
#endif
#ifndef USE_TINYOS_NODEIDS
#define USE_TINYOS_NODEIDS 0
#endif
#ifndef FLOCKLAB
#define FLOCKLAB 0
#endif
...
#endif
#ifndef LOCAL_NODES
#define LOCAL_NODES 0
#endif
#ifndef BURN_NODE_ID
#define BURN_NODE_ID 0
#ifndef LOCAL_NODE_ID
#define LOCAL_NODE_ID 0
#endif
#endif
#ifndef WHISPER_PREAMBLE_LENGTH
#define WHISPER_PREAMBLE_LENGTH 2
#endif
#ifndef WHISPER_PACKET_LENGTH
#define WHISPER_PACKET_LENGTH 7
#endif
#ifndef WHISPER_CLOCKDRIFT_COMP
#define WHISPER_CLOCKDRIFT_COMP 1
#endif
#ifndef WHISPER_DC_WITH_APP
#define WHISPER_DC_WITH_APP 0//1
#endif
#ifndef WHISPER_RADIO_ALWAYS_ON
#define WHISPER_RADIO_ALWAYS_ON 0
#endif
#ifndef WHISPER_AGNOSTIC_SAMPLING
#define WHISPER_AGNOSTIC_SAMPLING 0
#endif
#ifndef WHISPER_DIRECTION_AWARE_SAMPLING
#define WHISPER_DIRECTION_AWARE_SAMPLING 1
#endif
#ifndef WHISPER_DIRECTION_MODE
#define WHISPER_DIRECTION_MODE 1
#endif
#ifndef WHISPER_MANY_SENDERS
#define WHISPER_MANY_SENDERS 0    // 0: Changing single senders, 1: Close senders, 2: Distributed senders
#endif                              
#ifndef CC2420_ENABLE_TESTMODE
#define CC2420_ENABLE_TESTMODE 0//1
#endif
#ifndef WHISPER_LONG_WAKEUP_PACKET
#define WHISPER_LONG_WAKEUP_PACKET 0
#endif 
#ifndef WHISPER_NTX
#define WHISPER_NTX 3
#endif
#ifndef CC2420_DEFAULT_TX_POWER
#define CC2420_DEFAULT_TX_POWER 31
#endif
#ifndef CC2420_LOW_TX_POWER
#define CC2420_LOW_TX_POWER 3
#endif
#ifndef MEASURE_IDLE_LISTENING
#define MEASURE_IDLE_LISTENING 0
#endif
#ifndef WITH_GLOSSY
#define WITH_GLOSSY 0
#endif


#define WHISPER_MAX_COUNTER_LEN 5
...
#define PROCESS_CONF_NUMEVENTS 5 //8
...
#define UIP_CONF_BUFFER_SIZE		64//128//240
#endif
#define UIP_CONF_IPV6_RPL 0
#define NETSTACK_CONF_NETWORK laneflood_network_driver
#define NETSTACK_CONF_LLSEC laneflood_llsec_driver
